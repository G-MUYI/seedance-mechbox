...
### 机械魔盒系列
- **seedance-mechbox** - 通用机械魔盒提示词生成器
- **seedance-american-truckbox** - 美国卡车主题机械魔盒
- **seedance-tiktok-us-mechbox** - TikTok 美国州主题机械魔盒
- **seedance-country-mechbox** - 国家主题机械魔盒
- **seedance-world-cup-mechbox** - 世界杯主题机械魔盒
...
**本项目的核心理念：不是套模板填空，而是从最终目标物的结构特征倒推机械盒子的设计。**
...
1. **完整合同优先**：默认按各 skill 的 `references/generator.md` 输出完整可用提示词
2. **权重分配**：参考资产 (22%) > 任务描述 (18%) > 时间轴 (17%) > 风格 (9%)
3. **时间轴格式**：保留各 skill 规定的显式时间戳，每个节拍一个主动作
4. **硬限制才压缩**：平台给出字符上限时，只做结构保留型压缩，不使用独立短版模板
